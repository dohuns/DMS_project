		...
		<c:when test="${sessionScope.m_nick != null}">	
			<div class="container" style="width: 800px;">
				<div align="center">
					<h1>답글 페이지</h1>
					<div align="left">
						<form action="reply_save" id="fo"  method="post" enctype="multipart/form-data">
							<!-- 게시판 선택 -->
							<div>
								<h5>게시판</h5>
								<select name="b_article">
									<option value="${boardInfo.b_article}" selected="selected">${boardInfo.b_article}</option>
								</select>
								<!-- 게시판 카테고리 hidden으로 보내기 -->
								<input type="hidden" name="b_category"
									value="${boardInfo.b_category}"> <input type="hidden"
									name="b_group" value="${boardInfo.b_group}"> <input
