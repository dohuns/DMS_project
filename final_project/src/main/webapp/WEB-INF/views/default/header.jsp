	...
	<div align="right" style="padding-top:10px; margin: 10px 0;">
						<c:choose>
							...
							<c:when test="${sessionScope.m_rankNum == 1}">
								<b><a href="/movie/admin">관리자 페이지</a></b><span style="color: #f0f0f0"> | </span>
								<b><a href="/movie/logout">로그아웃</a></b><span style="color: #f0f0f0"> | </span>
								<b><a href="/movie/customerMain">고객센터</a></b>
							</c:when>
							<%-- 세션이 없는 경우 로그인, 회원가입 출력 --%>
							<c:when test="${sessionScope.m_nick == null}">
								<b><a href="/movie/login">로그인</a></b><span style="color: #f0f0f0"> | </span>
								<b><a href="/movie/regist_email">회원가입</a></b><span style="color: #f0f0f0"> | </span>
								<b><a href="/movie/customerMain">고객센터</a></b>
							</c:when>
							<%-- 세션이 있는 경우 로그아웃, 내정보 출력 --%>
							<c:otherwise>
								<b><a href="/movie/myPageCk">내정보</a></b><span style="color: #f0f0f0"> | </span>
								<b><a href="/movie/logout">로그아웃</a></b><span style="color: #f0f0f0"> | </span>
								<b><a href="/movie/customerMain">고객센터</a></b>
							</c:otherwise>
						</c:choose>
