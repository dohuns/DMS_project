						...
						<div class="box">
							...
							<div class="box-content">
								<div class="table-container">
									<table id="edit_account" class="table is-datatable dataTable">
										...
										<tbody>
											...
											<tr>
												<td>Name</td>
												<td><input type="text" value="Oilman, Inc"
													class="form-control"></td>
												<td></td>
											</tr>
											<tr>
												<td>Address</td>
												<td><input type="text" value="Portland"
													class="form-control"></td>
												<td></td>
											</tr>
											<tr>
												<td>Email</td>
												<td><input type="text" value="gumatt@gmail.com"
													class="form-control"></td>
												<td></td>
											</tr>
										</tbody>
								...
								<div class="modal-footer">
									<button id="update_account" type="submit"
										class="btn btn-primary" onclick="update_account()">Save</button>
								</div>
							</div>
									...
									<table id="users" class="table is-datatable">
										...
										<tbody>
											<c:forEach var="list" items="${memberList}">
												<c:choose>
													<c:when test="${list.m_rankNum <= 2 && list.m_rn <= 3}">
														<tr>
							...
							<div class="box-content">
								<div class="table-container">
									<table id="inventories" class="table is-datatable">
										...
										<tbody>
											<c:forEach var="list" items="${normalList}">
												<c:choose>
													<c:when test="${list.m_rn <= 3}">
														<tr>
															<td class="select-checkbox no-filter"></td>
															<td class="no-filter">${list.m_id}</td>
															<td>${list.m_nick}</td>
