...
<div align="center">
	...
	<div style="width:500px;">
		...
		<div align="left">
			<b>새로운 비밀번호 :</b> <input type="text" name="m_pw" id="m_pw" placeholder="새로운 비밀번호" class="form-control" onblur="chkPw()"><br>
		</div>
		<div>
			<label id="label_pw"></label>
		</div>	
		<div align="left">
			<b>비밀번호 확인 :</b> <input type="text" name="m_pw_ck" id="m_pw_ck" placeholder="비밀번호 확인" class="form-control" onblur="chkRpw()"><br>
		</div>
		<div>
			<label id="label_pw_ck"></label>
		</div>
		<div align="left">
			<input type="button" onclick="pw_ck()" value="비밀번호 변경하기"  id="btn-changePw" class="btn btn-info">
		</div>
		</form>
	</div>
</div>
