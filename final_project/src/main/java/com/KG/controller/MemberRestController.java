...
public class MemberRestController {
	...
	@ResponseBody
	public String mailSending(MemberDTO dto, HttpServletRequest request, HttpServletResponse response_email)
			throws Exception {
...
//	아이디 찾기 인증번호
	...
	@ResponseBody
	public int findId_send(MemberDTO dto, HttpServletRequest request, HttpServletResponse response_email)
			throws Exception {
...
//	비밀번호 찾기 인증번호
	...
	@ResponseBody
	public int findPw_send(MemberDTO dto, HttpServletRequest request, HttpServletResponse response_email)
			throws Exception {
	...
	public String chk_id(String m_id, Model model) throws JsonProcessingException {
		...
		ser = (MemberChkIdServiceImpl) AC.ac.getBean("memberChkIdServiceImpl");

		boolean flag = ser.execute_Boo(model);
